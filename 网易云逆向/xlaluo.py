...
var Xp7i = {}
Xp7i.md = ["色", "流感", "这边", "弱", "嘴唇", "亲", "开心", "呲牙", "憨笑", "猫", "皱眉", "幽灵", "蛋糕", "发怒", "大哭", "兔子", "星星", "钟情", "牵手", "公鸡", "爱意", "禁止", "狗", "亲亲", "叉", "礼物", "晕", "呆", "生病", "钻石", "拜", "怒", "示爱", "汗", "小鸡", "痛苦", "撇嘴", "惶恐", "口罩", "吐舌", "心碎", "生气", "可爱", "鬼脸", "跳舞", "男孩", "奸笑", "猪", "圈", "便便", "外星", "圣诞"]
Xp7i.emj = {
        "色": "00e0b",
        "流感": "509f6",
        "这边": "259df",
...
function main(page,cursor){

    var i0x = {"rid":"R_SO_4_1901371647","threadId":"R_SO_4_1901371647","pageNo":page.toString(),"pageSize":"20","cursor":cursor,"offset":"0","orderType":"1","csrf_token":""}
    var bVj0x = d(
        JSON.stringify(i0x),
        '010001',
